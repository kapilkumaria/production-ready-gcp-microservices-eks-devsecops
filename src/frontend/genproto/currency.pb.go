...
const file_currency_currency_proto_rawDesc = "" +
	"\n" +
	"\x17currency/currency.proto\x12\vhipstershop\x1a\x1bproductcatalog/common.proto\"\\\n" +
	"\x19CurrencyConversionRequest\x12&\n" +
	"\x04from\x18\x01 \x01(\v2\x12.hipstershop.MoneyR\x04from\x12\x17\n" +
	"\ato_code\x18\x02 \x01(\tR\x06toCode2Z\n" +
	"\x0fCurrencyService\x12G\n" +
	"\aConvert\x12&.hipstershop.CurrencyConversionRequest\x1a\x12.hipstershop.Money\"\x00B\"\n" +
...
var file_currency_currency_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
var file_currency_currency_proto_depIdxs = []int32{
	...
	0, // 1: hipstershop.CurrencyService.Convert:input_type -> hipstershop.CurrencyConversionRequest
	1, // 2: hipstershop.CurrencyService.Convert:output_type -> hipstershop.Money
