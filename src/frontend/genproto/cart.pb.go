...
// Response containing the user's cart.
...
func (x *AddItemResponse) GetEmpty() *Empty {
	if x != nil {
		return x.Empty
	}
	return nil
...
// Request to empty the user's cart.
...
func (x *EmptyCartResponse) GetEmpty() *Empty {
	if x != nil {
		return x.Empty
	}
	return nil
...
const file_cart_cart_proto_rawDesc = "" +
	"\n" +
	"\x0fcart/cart.proto\x12\vhipstershop\x1a\x1bproductcatalog/common.proto\"E\n" +
	"\bCartItem\x12\x1d\n" +
	"\n" +
	...
	"\x05items\x18\x01 \x03(\v2\x15.hipstershop.CartItemR\x05items\"T\n" +
	"\x0eAddItemRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12)\n" +
	"\x04item\x18\x02 \x01(\v2\x15.hipstershop.CartItemR\x04item\";\n" +
	"\x0fAddItemResponse\x12(\n" +
	"\x05empty\x18\x01 \x01(\v2\x12.hipstershop.EmptyR\x05empty\"+\n" +
	"\x10EmptyCartRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\"=\n" +
	"\x11EmptyCartResponse\x12(\n" +
	"\x05empty\x18\x01 \x01(\v2\x12.hipstershop.EmptyR\x05empty2\xeb\x01\n" +
	"\vCartService\x12F\n" +
	"\aGetCart\x12\x1b.hipstershop.GetCartRequest\x1a\x1c.hipstershop.GetCartResponse\"\x00\x12F\n" +
	"\aAddItem\x12\x1b.hipstershop.AddItemRequest\x1a\x1c.hipstershop.AddItemResponse\"\x00\x12L\n" +
	"\tEmptyCart\x12\x1d.hipstershop.EmptyCartRequest\x1a\x1e.hipstershop.EmptyCartResponse\"\x00B\"\n" +
...
var file_cart_cart_proto_goTypes = []any{
	...
	(*GetCartRequest)(nil),    // 1: hipstershop.GetCartRequest
	(*GetCartResponse)(nil),   // 2: hipstershop.GetCartResponse
	(*AddItemRequest)(nil),    // 3: hipstershop.AddItemRequest
	(*AddItemResponse)(nil),   // 4: hipstershop.AddItemResponse
	(*EmptyCartRequest)(nil),  // 5: hipstershop.EmptyCartRequest
	(*EmptyCartResponse)(nil), // 6: hipstershop.EmptyCartResponse
	(*Empty)(nil),             // 7: hipstershop.Empty
}
var file_cart_cart_proto_depIdxs = []int32{
	0, // 0: hipstershop.GetCartResponse.items:type_name -> hipstershop.CartItem
	0, // 1: hipstershop.AddItemRequest.item:type_name -> hipstershop.CartItem
	7, // 2: hipstershop.AddItemResponse.empty:type_name -> hipstershop.Empty
	7, // 3: hipstershop.EmptyCartResponse.empty:type_name -> hipstershop.Empty
	1, // 4: hipstershop.CartService.GetCart:input_type -> hipstershop.GetCartRequest
	3, // 5: hipstershop.CartService.AddItem:input_type -> hipstershop.AddItemRequest
	5, // 6: hipstershop.CartService.EmptyCart:input_type -> hipstershop.EmptyCartRequest
	2, // 7: hipstershop.CartService.GetCart:output_type -> hipstershop.GetCartResponse
	4, // 8: hipstershop.CartService.AddItem:output_type -> hipstershop.AddItemResponse
	6, // 9: hipstershop.CartService.EmptyCart:output_type -> hipstershop.EmptyCartResponse
