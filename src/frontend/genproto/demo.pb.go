...
const file_demo_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"demo.proto\x12\vhipstershop\x1a\x1bproductcatalog/common.proto\"\"\n" +
	"\fHelloRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\")\n" +
	"\rHelloResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2R\n" +
	"\vDemoService\x12C\n" +
	"\bSayHello\x12\x19.hipstershop.HelloRequest\x1a\x1a.hipstershop.HelloResponse\"\x00B\"\n" +
...
var file_demo_proto_goTypes = []any{
	(*HelloRequest)(nil),  // 0: hipstershop.HelloRequest
	(*HelloResponse)(nil), // 1: hipstershop.HelloResponse
}
var file_demo_proto_depIdxs = []int32{
	0, // 0: hipstershop.DemoService.SayHello:input_type -> hipstershop.HelloRequest
	1, // 1: hipstershop.DemoService.SayHello:output_type -> hipstershop.HelloResponse
